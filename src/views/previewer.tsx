...
export default class Previewer extends Component {
  ...
  componentDidMount(): void {
    ...
    iframe.onReady(async () => {
      ...
      await Promise.all([iframe.insertJS("https://cdnjs.cloudflare.com/ajax/libs/classnames/2.5.2/index.min.js"), iframe.insertJS("https://cdnjs.cloudflare.com/ajax/libs/axios/1.7.4/axios.min.js"), iframe.insertJS("/packages/@soda/core/core.umd.js")]);
      await iframe.insertJS("/packages/@soda/base/1.0.0/base.umd.js");
      iframe.insertStyle("/packages/@soda/base/1.0.0/style.css");
